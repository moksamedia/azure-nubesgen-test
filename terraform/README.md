...
```
curl "https://www.nubesgen.com/demo.tgz?iactool=TERRAFORM&region=eastus&application=APP_SERVICE.free&runtime=DOCKER_SPRING&database=SQL_SERVER.serverless&gitops=true" | tar -xzvf -
```
