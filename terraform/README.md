...
```
curl "https://www.nubesgen.com/demo.tgz?iactool=TERRAFORM&region=eastus&application=APP_SERVICE.free&runtime=SPRING&database=NONE.free&gitops=true" | tar -xzvf -
```
