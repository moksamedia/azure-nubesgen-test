...
```
curl "https://nubesgen.com/demo.tgz?iactool=TERRAFORM&region=eastus&application=SPRING_CLOUD.basic&runtime=DOCKER_SPRING&database=SQL_SERVER.serverless&gitops=true" | tar -xzvf -
```
